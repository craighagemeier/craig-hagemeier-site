      ...
      <article className="ch-container">
        ...
        <div className="ch-row">
          ...
          <div className="ch-col-xs-12 ch-col-sm-6 ch-order-xs-first ch-order-sm-last">
            ...
            <div className="ch-row">
              <div className="ch-col">
                <p>So that's the goal: 50 marathons, 50 states. One foot in front of the other, one state at a time. Because the journey isn't just about the finish line &mdash; it's about who you are becoming along the way. And that journey? It's nothing short of extraordinary.</p>
              </div>
            </div>
          </div>
        </div>
